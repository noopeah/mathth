...
{\Huge DEAR SLAVS, TODAY, I HAVE TO ASK YOU TO HELP ME! HELP ME AND THIS PROJECT BY REARRANGING QUESTIONS IN THE CORRENT ORDER, SO IT MAKES SENSE.
ALSO, I'D LIKE TO SEE PLACEHOLDERS FOR ALL OF THE QUESTIONS THAT ARE NOT IMPLEMENTED YET. \\
  {\Huge \LaTeX-хуячеры}}
...
если вместе с любой своей точкой она содержит и вс прямую, параллельную $\vec{p}$ и проходящую через эту точку. Такие прямые называются образующими.
...
\newline
  ...
  \begin{figure*}
    ...
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[scale=0.5]{./pics/jizz.png}
        \caption[r]{Пара плоскостей \\ \boxedeq{eq:*}{\frac{x^2}{a^2} - \frac{y^2}{b^2} = 0}}
    \end{subfigure}
    ~
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[scale=0.5]{./pics/joq.jpg}
